...
const DownloadSection = () => (
  <section className="text-center my-5 p-5" style={{ backgroundColor: '#f0f0f5', borderRadius: '15px' }}>
    <h2 className={styles.heading2} style={{ color: '#402a6f' }}>Download Our Mobile App</h2>
